    ...
    cx.render(rsx!(
        ...
        body {
            div {
                ...
                {
                    LazyNodes::new(|f| f.text(format_args!("<turbo-frame id='main-content' data-turbo-action='advance' target='_top' class='l_content'>")))
                }
                header {
                    class: "border-bottom",
                    label {
        ...
        {
            LazyNodes::new(|f| f.text(format_args!("</html>")))
        }
    ))
}
